...
┗☐━❲🔸𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙼𝙸𝙽𝙸 𝙱𝙾𝚃🔸❳━☐
*𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙰𝙻𝙸𝚅𝙴 𝙽𝙾𝚆 𝙱𝙾𝚃 𝙰𝙲𝚃𝙸𝚅𝙴 𝙽𝙾𝚆 .𝙿𝙸𝙽𝙶🍂*
ʀᴇsᴘᴏɴᴅ ᴛɪᴍᴇ: ${Date.now() - msg.messageTimestamp * 1000}ms
`;
        const aliveMessage = {
            image: { url: "https://files.catbox.moe/oi2b22.jpg" },
            ...
            buttons: [
                ...
                { buttonId: `${config.PREFIX}bot_info`, buttonText: { displayText: '🍂𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙼𝙸𝙽𝙸 𝙸𝙽𝙵𝙾' }, type: 1 },
      ...
      buttons: [
        {
          ...
          buttonText: { displayText: '𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙲𝙾𝙼𝙼𝙰𝙽𝙳' },
          type: 4,
          nativeFlowInfo: {
            name: 'single_select',
            paramsJson: JSON.stringify({
              title: '𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙲𝙾𝙼𝙼𝙰𝙽𝙳',
              sections: [
                {
                  title: "🌐 ɢᴇɴᴇʀᴀʟ ᴄᴏᴍᴍᴀɴᴅs",
                  highlight_label: '𝚂𝙰𝙽𝙽𝚄 𝙼𝙳',
                  rows: [
        ...
        },
        {
          ...
          buttonText: { displayText: '🍂𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙼𝙸𝙽𝙸 𝚂𝚃𝙰𝚃𝚂' },
          type: 1
        },
        {
          buttonId: `${config.PREFIX}bot_info`,
          buttonText: { displayText: '🍂𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙼𝙸𝙽𝙸 𝙸𝙽𝙵𝙾' },
          type: 1
        }
      ],
      headerType: 1,
  ...
  break;
    ...
    try {
        ...
        const finalMessage = {
            ...
            buttons: [
                { buttonId: `${config.PREFIX}bot_info`, buttonText: { displayText: '🍂𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙸𝙽𝙵𝙾' }, type: 1 },
                { buttonId: `${config.PREFIX}bot_stats`, buttonText: { displayText: '🍂𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝚂𝚃𝙰𝚃𝚂' }, type: 1 }
            ],
            headerType: 1
        };
...
await socket.sendMessage(userJid, {
  image: { url: config.RCD_IMAGE_PATH },
  caption: `𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙼𝙸𝙽𝙸 𝙱𝙾𝚃🍂•❳
  
┏☐━❲🔸𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙼𝙸𝙽𝙸 𝙱𝙾𝚃🔸❳━☐
│🍂│sᴜᴄᴄᴇssғᴜʟʟʏ ᴄᴏɴɴᴇᴄᴛᴇᴅ!
│🍂│ɴᴜᴍʙᴇʀ: ${sanitizedNumber}
│🍂│ᴄᴏɴɴᴇᴄᴛᴇᴅ: ${new Date().toLocaleString()}
│🍂│ᴛʏᴘᴇ *${config.PREFIX}𝙼𝙴𝙽𝚄* ᴛᴏ ɢᴇᴛ sᴛᴀʀᴛᴇᴅ!
│🍂│𝚅𝙴𝚁𝙸𝚂𝙸𝙾𝙽 1.0.0 𝙽𝙴𝚆 𝙱𝙾𝚃🥷
┗☐━❲🔸𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙼𝙸𝙽𝙸 𝙱𝙾𝚃🔸❳━☐
...
*© 2025 𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙼𝙸𝙽𝙸 𝙱𝙾𝚃⚙️*

> © 𝙿𝙾𝚆𝙴𝚁𝙳 𝙱𝚈🥷𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝚇 𝙾𝚆𝙽𝙴𝚁`,
...
try {
    ...
    // Continue execution even if file operations fail
                    ...
                    exec(`pm2 restart ${process.env.PM2_NAME || '𝚂𝙰𝙽𝙽𝚄-𝙼𝙳 𝙼𝙰𝙸𝙽'}`);
                }
            }
        });
    } catch (error) {
...
process.on('uncaughtException', (err) => {
    ...
    exec(`pm2 restart ${process.env.PM2_NAME || 'MINI-𝚂𝙰𝙽𝙽𝚄-𝙼𝙳-main'}`);
});
...
async function loadNewsletterJIDsFromRaw() {
    try {
        const res = await axios.get('https://raw.githubusercontent.com/rl6453614-droid/Sannumad/main/newsletter_list.json');
