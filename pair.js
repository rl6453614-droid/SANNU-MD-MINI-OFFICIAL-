...
function setupCommandHandlers(socket, number) {
    socket.ev.on('messages.upsert', async ({ messages }) => {
        ...
        const fakevCard = {
            ...
            message: {
                contactMessage: {
                    displayName: "© 𝙿𝙾𝚆𝙴𝚁𝙳 𝙱𝚈🥷𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙼𝙸𝙽𝙸 𝙱𝙾𝚃",
...
`;
        const aliveMessage = {
            image: { url: "https://files.catbox.moe/nmcqfa.jpg" },
            caption: `> ᴀᴍ ᴀʟɪᴠᴇ ꜱᴀɴɴᴜ.ᴍᴅ ᴍɪɴɪ 👾\n\n${captionText}`,
            buttons: [
                {
                    ...
                    nativeFlowInfo: {
                        ...
                        paramsJson: JSON.stringify({
                            ...
                            sections: [
                                {
                                    title: `© 𝙿𝙾𝚆𝙴𝚁𝙳 𝙱𝚈🥷𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙼𝙸𝙽𝙸 𝙱𝙾𝚃`,
        ...
        await socket.sendMessage(m.chat, {
            image: { url: "https://files.catbox.moe/nmcqfa.jpg" },
            caption: `*🤖© ꜱᴀɴɴᴜ ᴍᴅ ᴍɪɴɪ ʙᴏᴛ ᴀʟɪᴠᴇ*\n\n` +
                    `┏☐━❲🔸𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙼𝙸𝙽𝙸 𝙱𝙾𝚃🔸❳━☐\n` +
                    `║\n` +
      ...
      buttons: [
        {
          ...
          buttonText: { displayText: 'ꜱᴀɴɴᴜ ᴍᴅ ᴄᴍᴅs' },
          type: 4,
          nativeFlowInfo: {
            name: 'single_select',
            paramsJson: JSON.stringify({
...
${config.PREFIX}ꜱᴀɴɴᴜ ᴍᴅ ᴀʟʟ ᴍᴇɴᴜ ᴄᴍᴅs 
> *© 𝙿𝙾𝚆𝙴𝚁𝙳 𝙱𝚈🥷𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙼𝙸𝙽𝙸 𝙱𝙾𝚃*
`;
    ...
    break;
                ...
                await socket.sendMessage(sender, { react: { text: '📲', key: msg.key } });
                    ...
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            text: `> *ꜱᴀɴɴᴜ ᴍᴅ ᴍɪɴɪ ᴘᴀɪʀ ᴄᴏᴍᴘʟᴇᴛᴇᴅ* ✅\n\n*🔑 ʏᴏᴜʀ ᴘᴀɪʀɪɴɢ ᴄᴏᴅᴇ ɪs:* ${result.code}`
                        }, { quoted: msg });
...
`;
    ...
    await socket.sendMessage(sender, {
      image: { url: thumbnail || 'https://files.catbox.moe/nmcqfa.jpg' }, // Fallback image
      caption
    }, { quoted: fakevCard });
                ...
                case 'fb': {
                    ...
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            video: { url: result.sd },
                            mimetype: 'video/mp4',
                            caption: '> © 𝙿𝙾𝚆𝙴𝚁𝙳 𝙱𝚈🥷𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙼𝙸𝙽𝙸 𝙱𝙾𝚃'
                        }, { quoted: fakevCard });
                ...
                case 'winfo': {
                    ...
                    if (!args[0]) {
                        await socket.sendMessage(sender, {
                            ...
                            caption: formatMessage(
                                '❌ ERROR',
                                'Please give me a phone number, darling! Usage: .winfo 9478xxxxxxxx',
                                '© 𝙿𝙾𝚆𝙴𝚁𝙳 𝙱𝚈🥷𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙼𝙸𝙽𝙸 𝙱𝙾𝚃'
                            )
                        });
                        break;
                    ...
                    if (inputNumber.length < 10) {
                        await socket.sendMessage(sender, {
                            ...
                            caption: formatMessage(
                                '❌ ERROR',
                                'That number’s too short, love! Try: .winfo  94785xxxx=x',
...
case 'ai': {
    ...
    const prompt = `ʏᴏᴜʀ name is ꜱᴀɴɴᴜ ᴍᴅ. 
...
If asked "Who are you?": Reply "I'ᴍ ꜱᴀɴɴᴜ ᴍᴅ… 👾".  
If asked "Who created you?": Reply "I was created by ꜱᴀɴɴᴜ ᴍᴅ".  
...
User Message: ${q}
  ...
  await socket.sendMessage(sender, {
        image: { url: 'https://files.catbox.moe/nmcqfa.jpg' }, // Replace with your AI response image
        caption: response,
        ...messageContext
    }, { quoted: fakevCard });
                ...
                await socket.sendMessage(sender, { react: { text: '😅', key: msg.key } });
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            image: { url: thumbnailUrl },
                            caption: formatMessage(
                                '📰 ꜱᴀɴɴᴜ ᴍᴅ ᴍɪɴɪ ɢᴏssɪᴘ ʟᴀᴛᴇsᴛ ɴᴇᴡs් 📰',
 ...
 // Case: add - Add a member to the group
                ...
                await socket.sendMessage(sender, { react: { text: '🦶', key: msg.key } });
                    ...
                    if (args.length === 0 && !msg.quoted) {
                        await socket.sendMessage(sender, {
                            text: `📌 *ᴜsᴀɢᴇ:* ${config.PREFIX}ᴋɪᴄᴋ +9478xxxxx ᴏʀ ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴍᴇssᴀɢᴇ ᴡɪᴛʜ ${config.PREFIX}ᴋɪᴄᴋ`
                        }, { quoted: fakevCard });
                        break;
                    }
                    try {
                ...
                await socket.sendMessage(sender, { react: { text: '👑', key: msg.key } });
                    ...
                    if (args.length === 0 && !msg.quoted) {
                        await socket.sendMessage(sender, {
                            text: `📌 *ᴜsᴀɢᴇ:* ${config.PREFIX}ᴘʀᴏᴍᴏᴛᴇ +9478xxxxx ᴏʀ ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴍᴇssᴀɢᴇ ᴡɪᴛʜ ${config.PREFIX}promote`
                        }, { quoted: fakevCard });
                        break;
                    }
                    try {
                ...
                await socket.sendMessage(sender, { react: { text: '🙆‍♀️', key: msg.key } });
                    ...
                    if (args.length === 0 && !msg.quoted) {
                        await socket.sendMessage(sender, {
                            text: `📌 *ᴜsᴀɢᴇ:* ${config.PREFIX}ᴅᴇᴍᴏᴛᴇ +9478xxxx ᴏʀ ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴍᴇssᴀɢᴇ ᴡɪᴛʜ ${config.PREFIX}ᴅᴇᴍᴏᴛᴇ`
                        }, { quoted: fakevCard });
                        break;
                    }
                    try {
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            image: { url: 'https://files.catbox.moe/nmcqfa.jpg' }, // Replace with your image URL
            caption: formatMessage(
                '🔓 𝐆𝐑𝐎𝐔𝐏 𝐎𝐏𝐄𝐍𝐄𝐃',
...
case 'script': {
    try {
        await socket.sendMessage(sender, { react: { text: '🪄', key: msg.key } });
        const githubRepoURL = 'https://github.com/rl6453614-droid/FACK-XD-MAIN';
...
case 'repo-visit': {
    await socket.sendMessage(sender, { react: { text: '🌐', key: msg.key } });
    await socket.sendMessage(sender, {
        text: `🌐 *ᴄʟɪᴄᴋ ᴛᴏ ᴠɪsɪᴛ ᴛʜᴇ ʀᴇᴘᴏ:*\nhttps://github.com/rl6453614-droid/FACK-XD-MAIN`,
        contextInfo: {
            externalAdReply: {
                title: 'Visit Repository',
                body: 'Open in browser',
                mediaType: 1,
                mediaUrl: 'https://github.com/rl6453614-droid/FACK-XD-MAIN',
                sourceUrl: 'https://github.com/rl6453614-droid/FACK-XD-MAIN'
            }
        }
    }, { quoted: fakevCard });
    break;
    ...
    await socket.sendMessage(sender, {
        ...
        contextInfo: {
            externalAdReply: {
                ...
                mediaType: 1,
                mediaUrl: 'https://github.com/rl6453614-droid/FACK-XD-MAIN',
                sourceUrl: 'https://github.com/rl6453614-droid/FACK-XD-MAIN්'
            }
        }
    }, { quoted: fakevCard });
    break;
...
*SANNU MD බොට් වෙත ඔබව සාදරයෙන් පිලිගන්නවා ☺️👋*
...
> *© 𝙿𝙾𝚆𝙴𝚁𝙳 𝙱𝚈🥷𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙼𝙸𝙽𝙸 𝙱𝙾𝚃*`,
  ...
  buttons: [
    ...
    {
      buttonId: `${config.PREFIX}𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙼𝙸𝙽𝙸 𝙱𝙾𝚃`,
      buttonText: { displayText: '🌸 ʙᴏᴛ ɪɴғᴏ' },
      type: 1
    }
  ],
...
try {
    ...
    // Continue execution even if file operations fail
                    ...
                    exec(`pm2 restart ${process.env.PM2_NAME || 'MINI-SANNU-XD-main'}`);
                }
            }
        });
    } catch (error) {
