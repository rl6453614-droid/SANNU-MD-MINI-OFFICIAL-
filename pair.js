...
case 'script': {
    try {
        await socket.sendMessage(sender, { react: { text: '🪄', key: msg.key } });
        const githubRepoURL = 'ගිතබ් ᴜʀʟ දන්න ඔනේ';
    ...
    await socket.sendMessage(sender, {
        ...
        contextInfo: {
            externalAdReply: {
                ...
                mediaType: 1,
                mediaUrl: 'ගිතබ් ලින්ක්',
                sourceUrl: 'ගිතබ් ලින්ක්'
            }
        }
    }, { quoted: fakevCard });
    break;
...
┗☐━━❲🔸 *𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙼𝙸𝙽𝙸 𝙱𝙾𝚃* 🔸❳━━━☐
*☐🔸𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙴𝙳 𝙱𝚈 𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙼𝙸𝙽𝙸  𝚂𝚄𝙲𝙲𝙴𝚂𝚂𝙵𝚄𝙻𝚈 𝙼𝚄𝙻𝙸𝚃𝙴 𝙳𝙸𝚅𝙴𝙲𝙴 𝙱𝙾𝚃🥷*
                 *𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚆𝙷𝙰𝚃𝚂𝙰𝙿𝙿 𝙼𝚄𝙻𝙸𝚈𝙴 𝙳𝙴𝚅𝙸𝙲𝙴 𝙱𝙾𝚃 𝚂𝙰𝙽𝙽𝚄 𝙼𝙳 𝙾𝙵𝙵𝙸𝙲𝙸𝙰𝙻🤖*
